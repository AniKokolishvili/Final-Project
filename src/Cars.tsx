...
function Cars() {
    ...
    //make
    useEffect(() => {
        const id = selectedManufacturer[manID] ? selectedManufacturer[manID].value : undefined
        const fetchData = async () => {
    ...
    //         setModelsToSelect(fetchedModels);
    //     };
            ...
            <div className='filterContainer'>
                ...
                <div className='filter'>
                    ...
                    <Select
                        ...
                        isMulti
                        options={selectedManufacturer && selectedManufacturer.map((item) => ({
                            label: item.label,
                        ...
                        onChange={(selectedOptions) => {
                            ...
                            setSelectedModel(
                                selectedOptions ? selectedOptions.map((options) => {
